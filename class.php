...
final class BarcodeQR {
	 ...
	 * @param string $email
	 */
	public function contact($name = null, $email = null, $sirket = null, $unvan = null, $phone = null  ) {
		$this->_data = "MECARD:N:{$name};EMAIL:{$email};TEL:{$phone};ORG:{$sirket};TITLE:{$unvan};";
	...
	public function draw($size = 150, $filename = null) {
		...
		curl_setopt($ch, CURLOPT_POSTFIELDS, "chs={$size}x{$size}&choe=utf-8&cht=qr&chl=". utf8_encode($this->_data) );
